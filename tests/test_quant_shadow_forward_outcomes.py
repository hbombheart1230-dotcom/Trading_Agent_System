...
def test_attach_forward_outcomes_rejects_stale_baseline_day() -> None:
    candidates = [{
        "symbol": "005930",
        "_payload_generated_at": "2026-06-23T03:52:07+00:00",
        "shadow_forward_base": {
            "available": True,
            "baseline_epoch": 1757572200,
            "baseline_price": 902.0,
            "baseline_raw_ts": "20250911153000",
        },
    }]
    minute_rows = {
        "005930": [{
