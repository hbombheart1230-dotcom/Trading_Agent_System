        ...
        json.dumps(
            {
                ...
                "entries": [
                    ...
                    {"date": "2026-08-28", "version": "v2", "title": "Current", "stage": "Operations", "types": ["WEB_UI", "ALPHA"], "summary": "current summary", "details": ["current detail"], "impact": "current impact", "sources": ["docs/current.md"], "status": "current"},
                ],
            },
            ensure_ascii=False,
        ),
