# Agent Pipeline Trace (a5582768e95746c9b1b6d9cb689f7fbc)
...
- route_ts: `2026-03-18T01:38:05+00:00`
- end_status: **ok**
...
- position_age_seconds=830 min_hold_blocked=False sell_cooldown_blocked=False
...
## Next Command
- `python scripts/run_agent_pipeline_trace_report.py --run-id a5582768e95746c9b1b6d9cb689f7fbc --json`
- `python scripts/query_trade_reason_chain.py --run-id a5582768e95746c9b1b6d9cb689f7fbc --only-broker-success`