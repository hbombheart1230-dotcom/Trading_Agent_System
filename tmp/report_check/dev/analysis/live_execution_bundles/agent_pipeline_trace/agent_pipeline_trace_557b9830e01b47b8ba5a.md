# Agent Pipeline Trace (557b9830e01b47b8ba5a254085d50856)
...
- route_ts: `2026-03-18T00:20:36+00:00`
- end_status: **ok**
...
- entry_reason=hard_stop exit_reason=hard_stop monitor_reason=confirmed_exit_signal
- position_age_seconds=81789 min_hold_blocked=False sell_cooldown_blocked=False
- thresholds: `{"hard_stop_pct": 0.01, "stop_loss_pct": 0.08, "take_profit_pct": 0.009355500000000003, "max_hold_sec": 0, "time_stop_sec": 0, "trailing_stop_pct": 0.04, "vol_expansion_ratio": 1.6, "news_shock_threshold": 0.0, "peak_drawdown_exit_pct": 0.007040000000000001, "vwap_breakdown_pct": 0.005, "intraday_low_break_pct": 0.002, "trend_strength_floor": -0.15, "eod_flat_cutoff_min": 10, "effective_stop_loss_pct": 0.01, "effective_stop_reason": "hard_stop"}` min_hold=1200 sell_cooldown=420 confirm_ticks=4
- strategy_frame_adjustments: `["monitor_guidance:hold_through_noise"]`
...
- api_id=ORDER_SUBMIT url=https://mockapi.kiwoom.com/api/dostk/ordr action=SELL symbol=322000 qty=1
...
## Next Command
- `python scripts/run_agent_pipeline_trace_report.py --run-id 557b9830e01b47b8ba5a254085d50856 --json`
- `python scripts/query_trade_reason_chain.py --run-id 557b9830e01b47b8ba5a254085d50856 --only-broker-success`