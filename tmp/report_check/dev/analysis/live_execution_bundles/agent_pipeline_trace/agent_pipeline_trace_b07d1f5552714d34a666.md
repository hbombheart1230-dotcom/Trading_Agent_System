# Agent Pipeline Trace (b07d1f5552714d34a666c9c49c19cba9)
...
- route_ts: `2026-03-18T01:07:57+00:00`
- end_status: **ok**
...
- position_age_seconds=1865 min_hold_blocked=False sell_cooldown_blocked=False
...
## Next Command
- `python scripts/run_agent_pipeline_trace_report.py --run-id b07d1f5552714d34a666c9c49c19cba9 --json`
- `python scripts/query_trade_reason_chain.py --run-id b07d1f5552714d34a666c9c49c19cba9 --only-broker-success`