# Aggregated Execution Bundle (557b9830e01b47b8ba5a254085d50856)

- day: **2026-03-18**
- story_anchor: **SELL 322000 x1 | run 557b9830e01b47b8ba5a254085d50856**
...
SELL was triggered because hard_stop.

- Posture: SELL
- Trigger type: hard_stop
- Monitor reason: confirmed_exit_signal
- Position age: 81789 seconds
- Stop loss: 8.00%
- Effective stop: 1.00%
...
- Symbol reviewed: 322000
- Approval mode: not captured in the execution trace

## Execution Outcome

SELL order for 322000 x1 was approved and recorded successfully in simulation mode.
...
Current action is SELL. SELL order for 322000 x1 was approved and recorded successfully in simulation mode.
...
- monitor_signal: SELL was triggered because hard_stop.
- supervisor_approval: Supervisor approved the order because Allowed.
- broker_result: SELL order for 322000 x1 was approved and recorded successfully in simulation mode.
- reporter_output: Monitor behavior showed overtrading or rapid exit pressure in this run window.

## Artifacts

- agent_pipeline_trace_json: `tmp\report_check\dev\analysis\live_execution_bundles\agent_pipeline_trace\agent_pipeline_trace_557b9830e01b47b8ba5a.json`
- agent_pipeline_trace_md: `tmp\report_check\dev\analysis\live_execution_bundles\agent_pipeline_trace\agent_pipeline_trace_557b9830e01b47b8ba5a.md`
...
- trade_lifecycle_json: `tmp\report_check\trades\2026-03-18\TRD_20260318_322000_01\lifecycle\trade_lifecycle.json`
- trade_story_input_json: `tmp\report_check\trades\2026-03-18\TRD_20260318_322000_01\ai_trade_report\ai_trade_report_input.json`
- ai_trade_report_input_json: `tmp\report_check\trades\2026-03-18\TRD_20260318_322000_01\ai_trade_report\ai_trade_report_input.json`
- trade_report_json: ``
- trade_report_md: ``
- ai_trade_report_json: ``
- ai_trade_report_md: ``
- strategist_llm_response_json: `tmp\report_check\trades\2026-03-18\TRD_20260318_322000_01\strategist\strategist_llm_response.json`
- ai_trade_report_llm_response_json: ``
- strategist_evidence_json: `tmp\report_check\trades\2026-03-18\TRD_20260318_322000_01\evidence\strategist_evidence.json`
- scanner_evidence_json: `tmp\report_check\trades\2026-03-18\TRD_20260318_322000_01\evidence\scanner_evidence.json`
- monitor_timeline_json: `tmp\report_check\trades\2026-03-18\TRD_20260318_322000_01\evidence\monitor_timeline.json`
