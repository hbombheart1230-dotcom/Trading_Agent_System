...
COMMANDER_TEMPORARY_RUNTIME_ENV_DEFAULTS = {
    ...
    "USE_STRATEGY_MEMORY_FEEDBACK": "true",
    "USE_STRATEGY_PERFORMANCE_MEMORY": "true",
    "COMMANDER_MEMORY_USAGE_DISABLED": "false",
    "STRATEGIST_MEMORY_USAGE_DISABLED": "false",
    "STRATEGY_MEMORY_PERSIST_ENABLED": "true",
}
