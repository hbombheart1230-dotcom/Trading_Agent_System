...
from libs.runtime.entrypoints.m28_registration_helpers import main as helper_main
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--report-dir", default="reports/milestones/m28_registration_helpers")
