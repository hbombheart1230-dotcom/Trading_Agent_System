...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--m30-post-golive-dir", default="reports/m30_post_golive")
    p.add_argument("--m30-golive-dir", default="reports/m30_golive")
    p.add_argument("--m31-slo-incident-dir", default="reports/m31_slo_incident")
