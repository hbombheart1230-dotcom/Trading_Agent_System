...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--event-log-path", default="data/logs/offhours_full_trace.jsonl")
    p.add_argument("--evidence-log-path", default="data/evidence_ledger/offhours_full_trace.jsonl")
    p.add_argument("--report-dir", default="reports/offhours_full_trace")
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    event_log_path = _resolve_path(str(args.event_log_path), "data/logs/offhours_full_trace.jsonl")
    evidence_log_path = _resolve_path(str(args.evidence_log_path), "data/evidence_ledger/offhours_full_trace.jsonl")
    report_root = _resolve_path(str(args.report_dir), "reports/offhours_full_trace")
