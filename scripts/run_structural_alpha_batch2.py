...
from libs.research.structural_alpha_batch2 import run_structural_alpha_batch2


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run structural alpha batch 2 offline."
    )
    ...
    result = run_structural_alpha_batch2(
        start=args.start,
        end=args.end,
